...
----------------------------------
3.8K May  1 13:03 Deque.java
 423 May  1 13:03 Permutation.java
3.4K May  1 13:03 RandomizedQueue.java
...
% pmd .
*-----------------------------------------------------------
Permutation.java:12: Avoid using assignment statements in expressions; this can make code harder to read. [AssignmentInOperand]
...
% checkstyle *.java
*-----------------------------------------------------------
[WARN] Deque.java:7:17: The instance variable 'N' must start with a lowercase letter and use camelCase. [MemberName]
[WARN] Deque.java:39:26: Inner assignments should be avoided. [InnerAssignment]
[WARN] Deque.java:57:26: Inner assignments should be avoided. [InnerAssignment]
[WARN] RandomizedQueue.java:9:17: The instance variable 'N' must start with a lowercase letter and use camelCase. [MemberName]
[WARN] RandomizedQueue.java:84:22: The local (or parameter) variable 'i' has the same name as an instance variable. Use a different name. [HiddenField]
[WARN] RandomizedQueue.java:127:9: 'while' is not followed by whitespace. [WhitespaceAround]
